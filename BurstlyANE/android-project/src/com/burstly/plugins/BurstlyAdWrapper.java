...
public class BurstlyAdWrapper {
	...
	public enum BurstlyEvent {
	    ...
	    public String getEventName()	{
	    	if (this == BurstlyEvent.BurstlyEventSucceeded)				return "BurstlyAdsEventSucceeded";
	    	if (this == BurstlyEvent.BurstlyEventFailed) 				return "BurstlyAdsEventFailed";
	    	if (this == BurstlyEvent.BurstlyEventTakeoverFullscreen)	return "BurstlyAdsEventTakeoverFullscreen";
	    	if (this == BurstlyEvent.BurstlyEventDismissFullscreen)		return "BurstlyAdsEventDismissFullscreen";
	    	if (this == BurstlyEvent.BurstlyEventHidden) 				return "BurstlyAdsEventHidden";
	    	if (this == BurstlyEvent.BurstlyEventShown) 				return "BurstlyAdsEventShown";
	    	if (this == BurstlyEvent.BurstlyEventCached) 				return "BurstlyAdsEventCached";
	    	if (this == BurstlyEvent.BurstlyEventClicked) 				return "BurstlyAdsEventClicked";
	    	return "";
	    }
	}
